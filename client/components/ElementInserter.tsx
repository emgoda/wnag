...
export default function ElementInserter({
  ...
  const [insertMode, setInsertMode] = useState<"before" | "after" | "inside">(
    "after",
  );
  ...
  const clearTargetHighlights = (doc: Document) => {
    const highlighted = doc.querySelectorAll(
      ".element-inserter-target, .element-inserter-before, .element-inserter-after",
    );
    highlighted.forEach((el) => {
      el.classList.remove(
        "element-inserter-target",
        "element-inserter-before",
        "element-inserter-after",
      );
    });
  };
          ...
          <Card className="shadow-lg">
            <CardHeader className="pb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Select
                  value={insertMode}
                  onValueChange={(value: "before" | "after" | "inside") =>
                    setInsertMode(value)
                  }
                >
